      ...
      <div className="pointer-events-auto relative">
        ...
        >
          ...
          <div className="flex items-center gap-1">
            {/* タブレット以上：アプリケーション名 */}
            <h1 className="hidden sm:block text-xl sm:text-2xl font-bold text-gray-800">保育DB</h1>
            <span className="hidden sm:block px-2 py-0.5 mb-4 text-xs font-semibold text-white bg-gradient-to-r from-blue-400 to-blue-500 rounded-full">
              beta
            </span>
          </div>
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-white text-gray-800 border border-gray-200 hover:bg-gray-50 active:scale-[0.98] transition cursor-pointer"
            aria-label="区別で絞り込み"
          >
